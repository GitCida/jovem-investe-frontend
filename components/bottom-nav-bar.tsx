...
type Route = 'index' | 'exercises' | 'dashboard' | 'calculator' | 'simple-interest' | 'percentage' | 'simple-interest-summary' | 'simple-interest-exercises' | 'percentage-summary' | 'percentage-exercises' | 'profile';
